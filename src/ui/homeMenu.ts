...
const MONSTOS_PROFILES: Record<PieceType, MonstosProfile> = {
  I: {
    pieceType: 'I',
    name: 'BLYNDOOLIE',
    lore: "it sees all! good luck sneaking up... wait... it doesn't even blink... is it drooling on its own eyes?",
    previewRotation: 1,
  ...
  T: {
    pieceType: 'T',
    name: 'LYSERGICADA',
    lore: 'Might as well be lobotomized. Successfully managed to have naturally occurring traces of lysergic acid diethylamide secreting from the saliva glands. The same fungus variant we developed to thrive inside its body has... gone above and beyond to say the least. It is safe to say the host is no longer in control.',
    previewRotation: 2,
  ...
  Z: {
    pieceType: 'Z',
    name: 'AGGRASO',
    lore: "The first one that didn't melt into goop... ectodermal influx. A minor overcorrection on our part. Approach with caution.",
    previewRotation: 0,
  ...
  J: {
    pieceType: 'J',
    name: 'DOUSEMA',
    lore: 'Surprisingly resilient. All teeth and four of its eyes were redistributed to more promising candidates. But... had I realized the potential sooner... what a waste.',
    previewRotation: 3,
  ...
  L: {
    pieceType: 'L',
    name: 'GALIFFAMBOS',
    lore: "It will definitely hear you before it sees you... the larger of its eyes developed an infection; antibiotics proved effective, but irreparable damage had already been done. Lower eyelid had to be surgically removed and the eye has lost all function, but I did not see reason to remove it. I'd rather not risk having to make another.",
    previewRotation: 1,
