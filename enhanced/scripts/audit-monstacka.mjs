...
async function getGameSnapshot(page) {
  return page.evaluate(() => ({
    ...
    boardFigureCount: document.querySelectorAll('#boardMonsterLayer .board-piece-figure').length,
    boardMonsterBodies: document.querySelectorAll('#boardMonsterLayer .monster-figure-body').length,
    boardMonsterArt: document.querySelectorAll('#boardMonsterLayer .monster-art').length,
    boardRippleArt: document.querySelectorAll('#boardMonsterLayer .monster-ripple-art').length,
